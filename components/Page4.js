...
const Home = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
          ...
          <View key={card.id} style={styles.cardContainer}>
            ...
            <View style={styles.cardInfoContainer}>
              <View style={styles.cardInfoItem}>
                <Text style={styles.cardInfoLabel}>TITULAR DO CARTÃO</Text>
                <Text style={styles.cardInfoValue}>{card.holder}</Text>
              </View>
              <View style={styles.cardInfoItem}>
                <Text style={styles.cardInfoLabel}>EXPIRAÇÃO</Text>
      ...
      <TouchableOpacity onPress={goToPage5} style={styles.paymentButton}>
        <Text style={styles.buttonText}>Connfirma Pagamento</Text>
      </TouchableOpacity>
